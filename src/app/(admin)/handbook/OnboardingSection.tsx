  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <TaskCard title="BATON ada versi mobile gak?">
        ...
        <p>
          Admin Dashboard sekarang punya domain sendiri:{" "}
          <strong>admin.baton.my.id</strong> (bukan <strong>baton.my.id</strong>,
          itu punya peminjam — beda PWA juga). Kalo mau install ke home screen,
          buka <strong>admin.baton.my.id</strong> di browser mobile lu, baru:
        </p>
