...
export function ContactLink({
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-lg border border-border px-3.5 py-2 text-caption font-medium text-foreground transition-colors hover:bg-muted",
        className,
      )}
    >
